...
class Document(BaseModel):
    ...
    course_code: str = Field(..., description="The course code associated with the document.")
    cloudflare_url: str = Field(..., description="The URL of the file stored in Cloudflare R2.")
    upload_timestamp: datetime = Field(default_factory=datetime.utcnow, description="The timestamp of when the file was uploaded.")
